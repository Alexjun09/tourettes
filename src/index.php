...
<body class="font-extralight grid grid-rows-[1fr_min-content] text-primary w-full h-full " id="journal-scroll">
    ...
    <div class="bg-contraste w-screen h-screen flex flex-col py-10 overflow-x-scroll lg:overflow-hidden">
        ...
        <div class="w-full h-full flex flex-row items-center px-4 sm:px-20 xl:px-0 xl:justify-around gap-10 max-h-[400px] xl:gap-20 overflow-x-scroll xl:overflow-x-hidden">
            <!-- card 1 -->
