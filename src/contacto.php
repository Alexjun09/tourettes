            ...
            <div class="w-full h-full relative flex flex-row justify-center items-center">
                ...
                <div class="flex flex-row absolute w-full h-[500px] justify-center items-center">
                    ...
                    <div id="FAQs" class="hidden z-40">
                        <div id="accordion-collapse" data-accordion="collapse" class="bg-white rounded-xl flex flex-col px-4 lg:px-0 w-full lg:max-w-[700px] xl:max-w-[1000px] overflow-y-scroll">
